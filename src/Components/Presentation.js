...
export default function Presentation() {
    ...
    return (
        ...
        <div className="presentation">
            ...
            { changeLangage === false ? 
                <p className='para-eng'>Welcome to my portfolio, I am Rinoshan Vijayakumar. Actually a second year 
                    ...
                    searching for an internship to gain experience in a professional settiing. You'll find below more information on me and my projects.
                </p>
            : 
                <p className='para-fr'>Bienvenue sur mon portfolio, je suis Rinoshan Vijayakumar. Je suis actuellement étudiant à Epitech Digital en
